...
from confluent_kafka.avro.AvroMessage import AvroDatum
...
class AvroSchema(object):
    ...
    def __init__(self, schema):
        ...
        # _schema should be treated as an immutable object and thus there is no need to recalculate the hash.
